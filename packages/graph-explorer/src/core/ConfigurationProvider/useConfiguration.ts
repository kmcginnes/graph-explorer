...
export const assembledConfigSelector = atom(get => {
...
export const assembledConfigSelectorLoadable = loadable(
  assembledConfigSelector
);

export default function useConfiguration() {
  // return useAtomValue(assembledConfigSelector);
  const configurationLoadable = useAtomValue(assembledConfigSelectorLoadable);
  const configuration =
    configurationLoadable.state === "hasData"
      ? configurationLoadable.data
      : undefined;
