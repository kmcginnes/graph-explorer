...
export const [activeConfigurationAtom, activeConfigurationStorage] =
  atomWithLocalForageStorage<string | null>("active-configuration", null);

export const [configurationAtom, configurationStorage] =
  atomWithLocalForageStorage<Map<string, RawConfiguration>>(
    "configuration",
    new Map()
  );
