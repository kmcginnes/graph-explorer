...
function RouteButton({
  ...
  return (
    <NavButton
      ...
      className={cn(
        "hover:text-primary-foreground text-muted-foreground font-base data-active:border-b-primary-foreground data-active:text-primary-foreground h-full cursor-pointer rounded-none border-y-3 border-y-transparent px-5 hover:bg-transparent data-active:bg-transparent data-active:font-bold dark:hover:bg-transparent",
        className,
      )}
      {...props}
    >
