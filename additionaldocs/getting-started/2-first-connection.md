...
This guide walks you through creating your first connection to a graph database
...
Once you have successfully created a connection, you can:

1. Explore the [basic usage guide](./3-basic-usage.md) to learn essential
   features
2. Learn about [graph visualization](../user-guide/2-graph-visualization.md)
   capabilities
3. Use the [Data Explorer](../user-guide/3-data-explorer.md) to browse your data
