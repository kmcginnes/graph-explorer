...
This guide covers the different ways to install and run Graph Explorer.
...
6. After completing the trusted certification step and refreshing the browser,
   you should now see the Connections UI. See the
   [first connection guide](./2-first-connection.md) to configure your first
   connection.
...
[Troubleshooting](../troubleshooting/1-common-issues.md) page for more
information. It contains workarounds for common issues and information on how to
